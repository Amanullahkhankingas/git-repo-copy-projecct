...
var ur = er(function(t2) {
  !function(e2, n2) {
    ...
    if (n2["seed" + s2] = f2, v2(n2.random(), e2), t2.exports) {
      t2.exports = f2;
      try {
        r2 = (init_crypto(), __toCommonJS(crypto_exports));
      } catch (t3) {
      }
    }
  }([], Math);
...
var rf;
var of = function() {
  return init_node_fetch(), __toCommonJS(node_fetch_exports);
};
var af = function() {
  function t2() {
    this.util = (init_util(), __toCommonJS(util_exports)), this.textEncoder = new this.util.TextEncoder();
  }
  return t2.prototype.fetch = function(t3, e2) {
...
function vf(t2) {
  ...
  return { dateSaved: new Date(), modelTopologyType: "JSON", modelTopologyBytes: null == t2.modelTopology ? 0 : ff(JSON.stringify(t2.modelTopology)), weightSpecsBytes: null == t2.weightSpecs ? 0 : ff(JSON.stringify(t2.weightSpecs)), weightDataBytes: null == t2.weightData ? 0 : t2.weightData.byteLength };
}
var mf = function() {
  function t2() {
...
function createFileSystem(fs2) {
  ...
  if (!fs2) {
    try {
      fs2 = (init_fs(), __toCommonJS(fs_exports));
    } catch (err) {
 ...
 * =============================================================================
 */
//# sourceMappingURL=face-api_js.js.map
